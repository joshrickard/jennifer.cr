  ...
  module Migration
    module TableBuilder
      ...
      class CreateTable < Base
        ...
        # Defines virtual/generated column *name* of *type* type that will use *as_query* expression to generate.
        #
        # Supported options:
        #
        ...
        #   t.string :first_name
        #   t.string :last_name
        #   t.virtual :full_name, :string, "first_name || ' ' || last_name", {:stored => true}
        # end
        # ```
        def virtual(name : String | Symbol, type : Symbol | String, as_query : String,
                    options : Hash(Symbol, AAllowedTypes) = DbOptions.new)
